...
> [!IMPORTANT]
> This document is an archived combined design and implementation-planning
> snapshot for the Rule Improvement orchestrator and the Triage, Investigation,
> and Action comparison harnesses. It is retained in its original language for
> historical context and is not the current source of truth for implementation
> status, priority, sequencing, Done Criteria, promotion, or approval.
>
> Refer to the current
> [Rule Improvement Orchestrator Contract](../rule-improvement/rule_improvement_orchestrator_contract.md),
> [Comparison Harness Contract](../rule-improvement/comparison_harness_contract.md),
> [Phase 6](../../roadmap/phase6.md), and
> [Main Roadmap](../../roadmap/roadmap.md).
>
> Sections named Current Position, Current Status, Near-Term Priority, and Done
> Criteria below describe earlier project stages and are non-canonical.
>
> Archived: 2026-08-06
